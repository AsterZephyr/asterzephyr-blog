...
<TechGraph src="/images/posts/obsidian-claude-code-个人配置最优解/architecture-overview.svg" title="架构总览" caption="Obsidian 前端 + Claude Code AI 代理 + iCloud 同步 + Git 版本控制" />

### 数据流

<Figure src="/images/posts/obsidian-claude-code-个人配置最优解/image.png" alt="image.png" />
...
<Callout type="warning" title="必装插件">
</Callout>
...
<Callout type="tip" title="Dataview 性能">
</Callout>
...
<Callout type="warning" title="核心集成">
</Callout>
...
<TechGraph src="/images/posts/obsidian-claude-code-个人配置最优解/rules-system.svg" title="Rules 规则系统" caption="分层的规则目录结构，按语言和职责组织" />

<Callout type="tip" title="按需配置">
</Callout>
...
<TechGraph src="/images/posts/obsidian-claude-code-个人配置最优解/claudian-vs-cli.svg" title="Claudian 插件 vs Obsidian CLI 定位对比" caption="一个在 Obsidian 里面帮你干活，一个在外面帮你送信" />
...
<TechGraph src="/images/posts/obsidian-claude-code-个人配置最优解/scenario-quick-note.svg" title="场景一：随手记点东西不想被打断" caption="CLI 配合全局快捷键，无需切换应用即可写入日记" />
...
<TechGraph src="/images/posts/obsidian-claude-code-个人配置最优解/scenario-git-workflow.svg" title="场景二：和其他软件打通工作流" caption="Git Hook 自动调用 CLI，开发环境和笔记库直接连通" />
...
<TechGraph src="/images/posts/obsidian-claude-code-个人配置最优解/scenario-automation.svg" title="场景三：后台自动整理资料" caption="cron 定时任务 + CLI，早上打开 Obsidian 直接看现成报告" />
...
<TechGraph src="/images/posts/obsidian-claude-code-个人配置最优解/scenario-safe-ai.svg" title="场景四：让终端里的 AI 操作更安全" caption="CLI 按 Obsidian 规范安全写入，不需要 AI 自己拼接 Markdown 格式" />
...
<TechGraph src="/images/posts/obsidian-claude-code-个人配置最优解/best-strategy.svg" title="最佳搭配策略" caption="根据工作场景选择 Claudian 插件、Claude Code + CLI 或 cron + CLI" />

<Callout type="tip" title="一句话总结">
</Callout>
...
<TechGraph src="/images/posts/obsidian-claude-code-个人配置最优解/icloud-sync.svg" title="iCloud 三端同步原理" caption="Obsidian 在 iOS 上原生支持 iCloud Drive 作为 vault 存储位置，系统自动双向同步" />
...
<TechGraph src="/images/posts/obsidian-claude-code-个人配置最优解/icloud-git-backup.svg" title="iCloud + Git 双保险策略" caption="iCloud 负责实时同步，Git 负责版本控制和灾难恢复" />
...
<TechGraph src="/images/posts/obsidian-claude-code-个人配置最优解/vault-directory.svg" title="Vault 目录规划" caption="Inbox Zero 工作流 + 主要目录各有入口，用 Dataview 动态生成内容列表" />
...
<Callout type="tip" title="MOC (Map of Content)">
</Callout>
