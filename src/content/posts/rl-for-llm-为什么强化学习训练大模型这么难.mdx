...
date: 2026-06-07
tags: [AI, 强化学习, LLM, GRPO, DAPO, DeepSeek-R1]
summary: "为什么 DeepSeek-R1 用 RL 能成功，但大多数学术界复现全失败？从 pass@k 的视角理解 RL 训练 LLM 的本质限制、五大失败模式和 entropy collapse 现象。"
draft: false
---
...
<TechGraph src="/images/posts/rl-for-llm-为什么强化学习训练大模型这么难/11-rl-landscape.svg" title="RL for LLM 算法全景" caption="从 PPO 到 GRPO/DAPO，各算法的定位和适用场景" />
...
<TechGraph src="/images/posts/rl-for-llm-为什么强化学习训练大模型这么难/14-rl-algorithms-compare.svg" title="RL 算法对比" caption="PPO/GRPO/DAPO/DPO 的核心差异和适用条件" />
...
<TechGraph src="/images/posts/rl-for-llm-为什么强化学习训练大模型这么难/13-rl-prerequisite.svg" title="RL 的前提条件" caption="RL 只能强化模型已有的能力，不能创造新能力" />
...
<TechGraph src="/images/posts/rl-for-llm-为什么强化学习训练大模型这么难/12-entropy-collapse.svg" title="Entropy Collapse 现象" caption="健康的 RL 训练 entropy 缓慢下降，不健康的急剧归零" />
...
- [AI Inference 学习 Roadmap 2026 全景图](/blog/ai-inference-学习-roadmap-2026全景图) -- 更宏观的 AI 推理工程学习路线，包含训练与推理的关系
